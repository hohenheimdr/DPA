...
void main_window::get_exg_data()
{
    ...
    imgValues = ImgSample1.get_Image_Values(config::ExG.Method, config::ExG.Threshold, config::ExG.Threshold_Value, config::ExG.invert),
...
void main_window::get_exr_data()
{
    ...
    imgValues = ImgSample1.get_Image_Values(config::ExR.Method, config::ExR.Threshold, config::ExR.Threshold_Value, config::ExR.invert);
...
void main_window::get_exgr_data()
{
    ...
    imgValues = ImgSample1.get_Image_Values(config::ExGR.Method, config::ExGR.Threshold, config::ExGR.Threshold_Value, config::ExGR.invert);
...
void main_window::on_chkB_exg_invert_clicked(bool checked)
{
    config::ExG.invert = checked;
    get_exg_data();
}
...
void main_window::on_chkB_exr_invert_clicked(bool checked)
{
    config::ExR.invert = checked;
    get_exr_data();
}
...
void main_window::on_chkB_exgr_invert_clicked(bool checked)
{
    config::ExGR.invert = checked;
    get_exgr_data();
}
...
void main_window::on_chkB_filter_invert_clicked(bool checked)
{
    config::Filter.invert = checked;
    get_filter_data();
}
