...
///----- Filter ------------------------------------------
    ...
    void on_chkB_exg_invert_clicked(bool checked);
    void on_chkB_exr_invert_clicked(bool checked);
    void on_chkB_exgr_invert_clicked(bool checked);
    void on_chkB_filter_invert_clicked(bool checked);
