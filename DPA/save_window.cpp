...
//-ExG---------------------------------------------------------------------------------------------------------------------
    ...
    {
        imgValues = SampleImage.get_Image_Values(config::ExG.Method, config::ExG.Threshold, config::ExG.Threshold_Value, config::ExG.invert);
...
//-ExR---------------------------------------------------------------------------------------------------------------------
    ...
    {
        imgValues = SampleImage.get_Image_Values(config::ExR.Method, config::ExR.Threshold, config::ExR.Threshold_Value, config::ExR.invert);
...
//-ExGR---------------------------------------------------------------------------------------------------------------------
    ...
    {
        imgValues = SampleImage.get_Image_Values(config::ExGR.Method, config::ExGR.Threshold, config::ExGR.Threshold_Value, config::ExGR.invert);
